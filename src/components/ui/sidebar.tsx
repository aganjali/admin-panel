...
function Sidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile, collapsible } =
    useSidebar();
...
function SidebarInset({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<"main"> & { variant?: "default" | "sticky-header" }) {
  return (
    <main
      ...
      className={cn(
        ...
        variant === "sticky-header"
          ? "md:peer-data-[variant=inset]:rounded-b-xl"
